...
#define ID_DRONE_ROLL_KP						60
#define ID_DRONE_ROLL_KI						61
#define ID_DRONE_ROLL_KD						62
#define ID_DRONE_PITCH_KP						63
#define ID_DRONE_PITCH_KI						64
#define ID_DRONE_PITCH_KD						65
//Id pour le pc
