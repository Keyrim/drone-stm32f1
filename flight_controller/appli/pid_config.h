...
float PID_SETTINGS_ROLL_ACCRO[PID_NB_SETTINGS] = {0.6f, 0.1f, 0.01f, PID_ANGLE_RATE_FREQUENCY, 250};
float PID_SETTINGS_PITCH_ACCRO[PID_NB_SETTINGS] = {0.5f, 0.1f, 0.01f, PID_ANGLE_RATE_FREQUENCY, 250};
