...
float PID_SETTINGS_ROLL_ACCRO[PID_NB_SETTINGS] = {0.8f, 0.5f, 0.015f, PID_ANGLE_RATE, 250};
float PID_SETTINGS_PITCH_ACCRO[PID_NB_SETTINGS] = {0.5f, 0.5f, 0.008f, PID_ANGLE_RATE, 250};
